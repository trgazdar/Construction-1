...
class Applicant(models.Model):
	...
	experience = fields.One2many(
		'hr.applicant.experience', 'employee_id', string="Experience", tracking=True)
	sequence = fields.Char(string='Patient Code', required=True, copy=False, readonly=True,
...
class EmployeeExperience(models.Model):
	...
	employee_id = fields.Many2one('hr.applicant', string="Employee")


	job_position = fields.Text(string="Job Position")
	previous_company = fields.Text(string="Previous Company")
	experience_date_from = fields.Date(string="Start Date",  tracking=True)
	experience_date_to = fields.Date(string="End Date",tracking=True)
