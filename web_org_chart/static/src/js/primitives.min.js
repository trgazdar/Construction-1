/*
 Basic Primitives orgDiagram v2.0.20
...
primitives.common.Connector.prototype.draw=function(a,b,c){var d,e,f,g=[],h=[],i,j,k,l,n,m,q,p;i=6*this.lineWidth;var s=4*this.lineWidth;p=1.5*s;var r,t,v=0,w=0,u,a=(new primitives.common.Rect(a)).offset(this.offset),b=(new primitives.common.Rect(b)).offset(this.offset);l=[];switch(this.connectorShapeType){case 1:l=[-p/2,p/2];break;case 0:l=[0]}this.transform=new primitives.common.Transform;this.transform.size=this.panelSize;this.transform.setOrientation(this.orientationType);this.transform.transformRect(a.x,
...
r.width:0,5*i);if(a.right()+v<b.left()||a.left()>b.right()+v)if(a.left()>b.right()?(d=new primitives.common.Point(a.left(),a.verticalCenter()),e=new primitives.common.Point(b.right(),b.verticalCenter()),v=7,w=3):(d=new primitives.common.Point(a.right(),a.verticalCenter()),e=new primitives.common.Point(b.left(),b.verticalCenter()),v=3,w=7),f=new primitives.common.Rect(d,e),q=d.y<=e.y,m=d.x<e.x,f.height<f.width){f.height<2*i&&f.offset(0,q?2*i:0,0,q?0:2*i);j=0;for(k=l.length;j<k;j+=1)n=l[j],g.push(new primitives.common.MoveSegment(d.x,
d.y+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),(q?f.top():f.bottom())+n,e.x,e.y+n));l=r.width<2*(f.width/5)?this._quadraticBezierPoint(d,new primitives.common.Point(f.horizontalCenter(),q?f.top():f.bottom()),e,0.5):new primitives.common.Point(d.x,q?f.top():f.bottom());t=new primitives.common.Rect(l.x+(m?p:-r.width-p),q?l.y-r.height-i:l.y+i,r.width,r.height)}else{j=0;for(k=l.length;j<k;j+=1)n=l[j],g.push(new primitives.common.MoveSegment(d.x,d.y+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+
n*(q!=m?1:-1),(q?f.top():f.bottom())+n,f.horizontalCenter()+n*(q!=m?1:-1),f.verticalCenter()+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+n*(q!=m?1:-1),(q?f.bottom():f.top())+n,e.x,e.y+n));t=new primitives.common.Rect(f.horizontalCenter()+(q!=m?p:-(p+r.width)),f.verticalCenter()-r.height/2,r.width,r.height)}else if(a.verticalCenter()<b.top()||a.verticalCenter()>b.bottom()){m=a.x<u.width/2;d=new primitives.common.Point(m?a.right():a.left(),a.verticalCenter());e=new primitives.common.Point(m?
b.right():b.left(),b.verticalCenter());w=v=m?3:7;f=new primitives.common.Rect(d,e);f.offset(10*i,0,10*i,0);q=d.y<=e.y;j=0;for(k=l.length;j<k;j+=1)n=l[j],g.push(new primitives.common.MoveSegment(d.x,d.y+n)),g.push(new primitives.common.QuadraticArcSegment(m?f.right()+n*(q?-1:1):f.left()-n*(q?-1:1),f.verticalCenter(),m?b.right():b.left(),b.verticalCenter()-n));l=this._quadraticBezierPoint(d,new primitives.common.Point(m?f.right():f.left(),f.verticalCenter()),e,0.5);t=new primitives.common.Rect(l.x+
(m?p/2:-p/2-r.width),l.y-r.height/2,r.width,r.height)}else{d=new primitives.common.Point(a.horizontalCenter(),a.top());e=new primitives.common.Point(b.horizontalCenter(),b.top());w=v=1;f=new primitives.common.Rect(d,e);f.offset(0,7*i,0,0);m=d.x<e.x;j=0;for(k=l.length;j<k;j+=1)n=l[j],g.push(new primitives.common.MoveSegment(d.x+n,d.y)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),f.top()-n*(m?-1:1),b.horizontalCenter()-n,b.top()));l=this._quadraticBezierPoint(d,new primitives.common.Point(f.horizontalCenter(),
f.top()),e,0.5);t=new primitives.common.Rect(l.x-r.width/2,l.y-(this.labelOffset+r.height),r.width,r.height)}if(0<g.length){this.transform.transformSegments(g,!0);switch(this.connectorShapeType){case 1:l=g[g.length/2-1];m=Math.atan2(l.cpY-l.y,l.cpX-l.x);h=h.concat(this._getArrow(l.x,l.y,i,s,m));m=this._offsetPoint(new primitives.common.Point(l.x,l.y),new primitives.common.Point(l.cpX,l.cpY),s);l.x=m.x;l.y=m.y;p=g[g.length/2];l=g[g.length/2+1];m=Math.atan2(l.cpY-p.y,l.cpX-p.x);h=h.concat(this._getArrow(p.x,
p.y,i,s,m));m=this._offsetPoint(new primitives.common.Point(p.x,p.y),new primitives.common.Point(l.cpX,l.cpY),s);p.x=m.x;p.y=m.y;break;case 0:l=g[g.length-1],m=Math.atan2(l.cpY-l.y,l.cpX-l.x),h=h.concat(this._getArrow(l.x,l.y,i,s,m)),m=this._offsetPoint(new primitives.common.Point(l.x,l.y),new primitives.common.Point(l.cpX,l.cpY),s),l.x=m.x,l.y=m.y}i={};null!==this.borderColor&&(i.borderColor=this.color);i.lineWidth=this.lineWidth;i.lineType=this.lineType;this.m_graphics.polyline(g,i);g={opacity:1};
...
primitives.common.Graphics.prototype._getVerticalAlignment=function(a){var b=null;switch(a){case 1:b="middle";break;case 0:b="top";break;case 2:b="bottom"}return b};
...
primitives.common.Graphics.prototype.template=function(a,b,c,d,e,f,g,h,i,j,k,l,n){var c=this.m_activePlaceholder,d="template"+(null!==j?j:primitives.common.hashCode(i)),m=0,j=this.m_cache.get(c.name,c.activeLayer.name,d);null!==n&&void 0!==n["border-width"]&&(m=this.boxModel?this.getPxSize(n["border-width"]):0);a={width:g-m+"px",height:h-m+"px",top:b+f+"px",left:a+e+"px"};jQuery.extend(a,n);null==l&&(l=new primitives.common.RenderEventArgs);null==j?(j=jQuery(i),jQuery.extend(a,{position:"absolute",
padding:"0px",margin:"0px"},n),primitives.common.css(j,a),l.element=j,l.renderingMode=0,null!==k&&this.m_widget._trigger(k,null,l),c.activeLayer.canvas.append(j),this.m_cache.put(c.name,c.activeLayer.name,d,j)):(l.element=j,l.renderingMode=1,primitives.common.css(j,a),null!==k&&this.m_widget._trigger(k,null,l));return j};
...
this.m_scrollPanel.css({position:"relative",top:'0px'});
this.m_scrollPanel.addClass(this.widgetEventPrefix);

this.m_placeholder=jQuery("<div></div>");this.m_placeholder.css({position:"absolute",overflow:"hidden",top:"0px",left:"0px"});this.m_placeholder.addClass("placeholder");this.m_placeholder.addClass(this.widgetEventPrefix);this.m_placeholder.css(this.m_placeholderRect.getCSS());this.m_scrollPanel.append(this.m_placeholder);
this.m_calloutPlaceholder=jQuery("<div></div>");this.m_calloutPlaceholder.css({position:"relative",overflow:"visible",});this.m_calloutPlaceholder.addClass("calloutplaceholder");this.m_calloutPlaceholder.addClass(this.widgetEventPrefix);
...
this.element.append(this.m_scrollPanel);this.options.enablePanning&&this._mouseInit(this.m_placeholder)};
...
a.actualPosition.y,a.actualPosition.width,a.actualPosition.height,!0,this,function(f,i,j,q){switch(a.actualVisibility){case 1:d=new primitives.common.RenderEventArgs;d.context=a.itemConfig;d.isCursor=a.isCursor;d.isSelected=a.isSelected;d.templateName=a.template.name;this.graphics.activate("placeholder",7);this.graphics.template(f,i,j,q,a.contentPosition.x,a.contentPosition.y,a.contentPosition.width,a.contentPosition.height,a.template.itemTemplate,a.template.itemTemplateHashCode,a.template.itemTemplateRenderName,
d,{"border-width":a.template.itemBorderWidth});a.actualHasGroupTitle&&this.graphics.template(f,i,j,q,2,a.contentPosition.y,this.options.groupTitlePanelSize-4,a.contentPosition.height+2,this._groupTitleTemplate,this._groupTitleTemplateHashCode,"onGroupTitleTemplateRender",a,null);a.actualHasSelectorCheckbox&&(this.graphics.activate("placeholder",10),this.graphics.template(f,i,j,q,a.contentPosition.x,a.actualSize.height-(this.options.checkBoxPanelSize-4),a.contentPosition.width,this.options.checkBoxPanelSize-
4,this._checkBoxTemplate,this._checkBoxTemplateHashCode,"onCheckBoxTemplateRender",a,null));a.actualHasButtons&&(this.graphics.activate("placeholder",10),this.graphics.template(f,i,j,q,a.actualSize.width-(this.options.buttonsPanelSize-4),a.contentPosition.y,this.options.buttonsPanelSize-4,Math.max(a.contentPosition.height,a.actualSize.height-a.contentPosition.y),this._buttonsTemplate,a.template.name+this._buttonsTemplateHashCode,"onButtonsTemplateRender",a,null));0==this.options.showLabels&&(k=new primitives.common.Label,
k.text=b.title,k.position=new primitives.common.Rect(f,i,j,q),k.weight=1E4,k.labelType=1,c.labels.push(k));break;case 2:e=b.itemTitleColor;null==e&&(e="#000080");g.hasOwnProperty(e)||(g[e]=[]);h=g[e];h.push(new primitives.common.DotSegment(f,i,j,q,a.template.minimizedItemCornerRadius));k=this._createLabel(f,i,j,q,a);null!=k&&c.labels.push(k);break;default:this._debug&&(e="#ff0000",g.hasOwnProperty(e)||(g[e]=[]),h=g[e],h.push(new primitives.common.DotSegment(f-1,i-1,2,2,1)))}}));this.graphics.activate("placeholder",
...
primitives.orgdiagram.BaseController.prototype._redrawConnector=function(a,b,c,d){var e=this,f,g,h,i,j,k,l,n,m,q=0,p,s=0==this.options.connectorType,r;m=0<c.partnerConnectorOffset?d.connectorShift-d.levelSpace/2*(d.partnerConnectorOffset-c.partnerConnectorOffset+1):c.connectorPlacement&4?c.actualPosition.bottom():d.connectorShift;1>=c.partnerConnectorOffset?b.selectPalette(0):1<c.partnerConnectorOffset?b.selectPalette(c.partnerConnectorOffset-1):b.selectPalette(d.partnerConnectorOffset);0<c.visualChildren.length&&
(f=4===c.actualVisibility&&c.id===this._visualRootItem,n=c.actualPosition.horizontalCenter());g=[];if(1<c.partners.length||0<c.extraPartners.length){h=c.partners;for(k=0;k<h.length;k+=1)i=this._treeItems[h[k]],p=new primitives.orgdiagram.ConnectorPoint(i.actualPosition.horizontalCenter(),i.actualPosition.bottom()),p.isSquared=!0,p.highlightPath=i.partnerHighlightPath,p.connectorStyleType=i.partnerHighlightPath?2:1,g.push(p);h=c.extraPartners;for(k=0;k<h.length;k+=1)i=this._treeItems[h[k]],p=new primitives.orgdiagram.ConnectorPoint(i.actualPosition.horizontalCenter(),
i.actualPosition.bottom()),p.isSquared=!0,p.highlightPath=i.partnerHighlightPath,p.connectorStyleType=i.partnerHighlightPath?2:0,g.push(p);0<g.length&&(g.sort(function(a,b){return a.x-b.x}),0==c.visualChildren.length&&(n=(g[0].x+g[g.length-1].x)/2),b.addInverted(function(b){e._drawTopConnectors(b,n,m,g,!0,a)}))}g=[];if(0<c.visualChildren.length){l=!1;h=c.visualChildren;for(k=0;k<h.length;k+=1)if(i=this._treeItems[h[k]],j=this._treeLevels[i.level],r=b.getPolyline(i.highlightPath?2:1).segments,i.connectorPlacement&
8)j=this._treeItems[j.treeItems[i.levelPosition-1]],this.transform.transformPoints(i.actualPosition.x,i.actualPosition.verticalCenter(),j.actualPosition.right(),i.actualPosition.verticalCenter(),!0,this,function(a,b,c,d){r.push(new primitives.common.MoveSegment(a,b));r.push(new primitives.common.LineSegment(c,d))});else if(i.connectorPlacement&2)j=this._treeItems[j.treeItems[i.levelPosition+1]],this.transform.transformPoints(i.actualPosition.right(),i.actualPosition.verticalCenter(),j.actualPosition.x,
i.actualPosition.verticalCenter(),!0,this,function(a,b,c,d){r.push(new primitives.common.MoveSegment(a,b));r.push(new primitives.common.LineSegment(c,d))});else if(i.connectorPlacement&1&&!f){j=!0;if(a)switch(i.actualVisibility){case 2:case 3:j=s}p=new primitives.orgdiagram.ConnectorPoint(i.actualPosition.horizontalCenter()+0,i.actualPosition.top());p.isSquared=j;p.connectorStyleType=i.highlightPath?2:1;g.push(p);q=Math.max(q,p.connectorStyleType);l=l||p.isSquared}!f&&0<g.length&&(this.transform.transformPoints(n,
m,n,d.connectorShift,!0,this,function(a,d,e,f){r=b.getPolyline(q).segments;this.showElbowDots&&(0!=this.options.elbowType&&0<c.partners.length)&&r.push(new primitives.common.DotSegment(a-1,d-1,2,2,1));r.push(new primitives.common.MoveSegment(a,d));r.push(new primitives.common.LineSegment(e,f));this.showElbowDots&&(0!=this.options.elbowType&&1<g.length)&&r.push(new primitives.common.DotSegment(e-1,f-1,2,2,1))}),this._drawTopConnectors(b,n,d.connectorShift,g,l,a))}};
primitives.orgdiagram.BaseController.prototype._drawTopConnectors=function(a,b,c,d,e,f){var g,h,i,j=[],k,l,n;if(e){j=[];e=0;for(h=d.length;e<h;e+=1)if(i=d[e],i.x<b&&!i.isSquared)j.push(i);else break;h=j.length;0<h&&this._drawAngularConnectors(a,b,c,j,!1);j=[];for(g=d.length-1;g>=e;g-=1)if(i=d[g],i.x>b&&!i.isSquared)j.push(i);else break;h=j.length;0<h&&this._drawAngularConnectors(a,b,c,j,!1);j={};h={};for(k in primitives.common.ConnectorStyleType)primitives.common.ConnectorStyleType.hasOwnProperty(k)&&
(j[primitives.common.ConnectorStyleType[k]]=b,h[primitives.common.ConnectorStyleType[k]]=b);for(k=e;k<=g;k+=1){i=d[k];l=a.getPolyline(i.connectorStyleType).segments;n=this.options.dotItemsInterval/2;2>n&&(n=0);if(f)switch(this.options.elbowType){case 2:case 3:0<n&&(Math.abs(b-i.x)>n&&Math.abs(c-i.y)>n)&&(i.hasElbow=!0,i.elbowPoint1=new primitives.common.Point(i.x,c+(c>i.y?-n:n)),i.elbowPoint2=new primitives.common.Point(i.x+(b>i.x?n:-n),c));break;case 1:0<g-e&&this.transform.transformPoints(i.x,c,
i.x,i.y,!0,this,function(a,b){l.push(new primitives.common.DotSegment(a-1,b-1,2,2,1))})}j[i.connectorStyleType]=Math.min(j[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x);h[i.connectorStyleType]=Math.max(h[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x)}f=[Math.max(0,e-1),Math.min(g+1,d.length-1)];for(k=0;k<f.length;k+=1)i=d[f[k]],j[i.connectorStyleType]=Math.min(j[i.connectorStyleType],i.hasElbow?i.elbowPoint2.x:i.x),h[i.connectorStyleType]=Math.max(h[i.connectorStyleType],i.hasElbow?
i.elbowPoint2.x:i.x);f=b;for(k=2;0<=k;k-=1)l=a.getPolyline(k).segments,i=j[k],null!=i&&i<f&&(this.transform.transformPoints(f,c,i,c,!0,this,function(a,b,c,d){l.push(new primitives.common.MoveSegment(a,b));l.push(new primitives.common.LineSegment(c,d))}),f=i),i=h[k],null!=i&&i>b&&(this.transform.transformPoints(b,c,i,c,!0,this,function(a,b,c,d){l.push(new primitives.common.MoveSegment(a,b));l.push(new primitives.common.LineSegment(c,d))}),b=i);for(k=e;k<=g;k+=1)i=d[k],l=a.getPolyline(i.connectorStyleType).segments,
i.hasElbow?(this.transform.transform3Points(i.elbowPoint2.x,i.elbowPoint2.y,i.elbowPoint1.x,i.elbowPoint2.y,i.elbowPoint1.x,i.elbowPoint1.y,!0,this,function(a,b,c,d,e,f){switch(this.options.elbowType){case 2:l.push(new primitives.common.MoveSegment(a,b));l.push(new primitives.common.LineSegment(e,f));break;case 3:l.push(new primitives.common.MoveSegment(a,b)),l.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}}),this.transform.transformPoints(i.elbowPoint1.x,i.elbowPoint1.y,i.x,i.y,!0,this,
function(a,b,c,d){l.push(new primitives.common.LineSegment(c,d))})):this.transform.transformPoints(i.x,c,i.x,i.y,!0,this,function(a,b,c,d){l.push(new primitives.common.MoveSegment(a,b));l.push(new primitives.common.LineSegment(c,d))})}else this._drawAngularConnectors(a,b,c,d,!0)};
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors=function(a,b,c,d,e){var f=null,g=d.length,h,i,j,f=e?b:d[g-1].x;i=new primitives.common.Point(f,c);for(b=0;b<g;b+=1)switch(h=d[b],j=a.getPolyline(h.connectorStyleType).segments,this.transform.transformPoint(f,c,!0,this,function(a,b){j.push(new primitives.common.MoveSegment(a,b))}),this.options.connectorType){case 1:this.transform.transformPoint(h.x,h.y,!0,this,function(a,b){j.push(new primitives.common.LineSegment(a,b))});break;
case 2:h=new primitives.common.Rect(i,h),e?f>h.x?this.transform.transform3Points(h.right(),h.verticalCenter(),h.x,h.verticalCenter(),h.x,h.bottom(),!0,this,function(a,b,c,d,e,f){j.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):this.transform.transform3Points(h.x,h.verticalCenter(),h.right(),h.verticalCenter(),h.right(),h.bottom(),!0,this,function(a,b,c,d,e,f){j.push(new primitives.common.CubicArcSegment(a,b,c,d,e,f))}):f>h.x?this.transform.transformPoints(h.x,h.y,h.x,h.bottom(),!0,this,
function(a,b,c,d){j.push(new primitives.common.QuadraticArcSegment(a,b,c,d))}):this.transform.transformPoints(h.right(),h.y,h.right(),h.bottom(),!0,this,function(a,b,c,d){j.push(new primitives.common.QuadraticArcSegment(a,b,c,d))})}};
...
primitives.orgdiagram.BaseController.prototype._virtualShowCursorNeighbours=function(){};primitives.orgdiagram.BaseController.prototype._getSelectionVisibility=function(a,b,c){var d=!1;switch(b){case 0:switch(c){case 0:d=a;break;case 1:d=!0;break;case 2:d=!1}break;case 1:d=!0;break;case 2:d=!1}return d};primitives.common.ReferenceItem=function(){this.key=this.name="";this.actualTargets=[];this.targets=[];this.processed=!1;this.isVisible=!0;this.level=0};
...
primitives.common.getGraphSpanningTree=function(a,b,c){var d={},e={},f,g=[],h={},i,j,k,l,n,m,q;e[b]=!0;i=1;for(h[b]=null;0<i;){g=[];l=k=j=null;for(f in e)if(e.hasOwnProperty(f)){n=a[f];b=!1;for(m in n)if(n.hasOwnProperty(m)&&!h.hasOwnProperty(m)&&(q=n[m],b=!0,!k||0<=c(q,k)))j=m,k=q,l=f;b||g.push(f)}if(null==j)break;else e[j]=!0,i+=1,h[j]=l,d.hasOwnProperty(l)||(d[l]=[]),d[l].push(j);b=0;for(j=g.length;b<j;b+=1)delete e[g[b]],i-=1}return d};
...
primitives.common.optimizeReferences=function(a,b){var c={},d=[],e={},f={},g,h,i,j,k,l,n,m,q,p,s;for(g in a)a.hasOwnProperty(g)&&(h=a[g],i=new primitives.common.ReferenceItem,h.sort(),i.key=h.join(","),i.name=g,i.targets=h.slice(0),i.actualTargets=h.slice(0),i.level=0,f[i.name]=i);for(;!primitives.common.isEmptyObject(f);){h={};i=primitives.common.getReferencesGraph(f);for(g in f)if(f.hasOwnProperty(g)&&(j=f[g],d.push(j),!j.processed))for(n in l=primitives.common.getGraphSpanningTree(i,g,function(a,
b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),l)if(l.hasOwnProperty(n)){f[n].processed=!0;m=l[n];j=0;for(k=m.length;j<k;j+=1)q=m[j],f[q].processed=!0,p=i[n][q],1<p.weight&&(g=p.items.join(","),s=null,e.hasOwnProperty(g)?s=e[g]:(s=new primitives.common.ReferenceItem,s.name=b(),s.key=g,s.actualTargets=p.items.slice(0),s.targets=p.items.slice(0),e[s.key]=s,h[s.name]=s),primitives.common.addGroup(f[n],s),primitives.common.addGroup(f[q],s))}f=h}j=0;for(k=d.length;j<k;j+=
...
primitives.common.getGraphGrowthSequence=function(a,b,c){var d=[b],e={},f,g=[],h={},i,j,k,l,n,m,q;e[b]=!0;i=1;for(h[b]=null;0<i;){g=[];k=j=null;l={};for(f in e)if(e.hasOwnProperty(f)){n=a[f];b=!1;for(m in n)if(n.hasOwnProperty(m)&&!h.hasOwnProperty(m)&&(q=c(n[m]),b=!0,null==l[m]&&(l[m]=0),l[m]+=q,!k||l[m]>k))j=m,k=l[m];b||g.push(f)}if(null==j)break;else e[j]=!0,i+=1,h[j]=!0,d.push(j);b=0;for(j=g.length;b<j;b+=1)delete e[g[b]],i-=1}return d};
primitives.common.mergeSort=function(a,b){var c=null,d,e,f,g,h,i,j,k,l,n,m;switch(a.length){case 0:c=[];break;case 1:c=a[0].slice(0);break;default:c=a[0];for(f=1;f<a.length;f+=1){d=a[f];e=[];i=c.length;j=d.length;h=g=0;m=l=n=k=null;0<i&&(k=c[g],n=!b?k:b(k));0<j&&(l=d[h],m=!b?l:b(l));for(;g<i||h<j;)g>=i?(e.push(l),h+=1,h<j&&(l=d[h],m=!b?l:b(l))):h>=j?(e.push(k),g+=1,g<i&&(k=c[g],n=!b?k:b(k))):n<m?(e.push(k),g+=1,g<i&&(k=c[g],n=!b?k:b(k))):(e.push(l),h+=1,h<j&&(l=d[h],m=!b?l:b(l)));c=e}}return c};
primitives.common.stackSegments=function(a,b){var c=0,d,e,f,g,h,i,j,k=[],l,n,m,q,p,s,r={};a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});g=0;for(h=a.length;g<h;g+=1){f=a[g];e=d=0;m=f.startIndex;r[m]=d+1;q=f.endIndex;r[q]=e;j=k.length;if(0<j){l=[];s=p=!1;for(i=0;i<j;i+=1)n=k[i],n<m?(l.push(n),d=r[n],e=r[n]):n<q?(p||(l.push(m),p=!0),d=Math.max(d,r[n]),e=r[n]):(p||(l.push(m),p=!0),s||(l.push(q),s=!0,r[m]=d+1,r[q]=e),l.push(n));p||(l.push(m),p=!0);s||(l.push(q),s=!0,r[m]=
d+1,r[q]=e);k=l}else k=[m,q];b(f,r[m]);c=Math.max(c,r[m])}return c};primitives.common.binarySearch=function(a,b){var c=null,d,e,f=0,g=a.length-1,h,i;if(0<a.length&&(c=a[f],d=b(c),0<d))if(e=Math.abs(d),i=a[g],d=b(i),0<=d)c=i;else{d=Math.abs(d);e>d&&(e=d,c=i);for(;f+1<g;)if(h=Math.round((f+g)/2),i=a[h],d=b(i),0==d){c=i;break}else 0<d?f=h:g=h,d=Math.abs(d),e>d&&(e=d,c=i)}return c};
...
Math.max(isNaN(c)?0:c,this.maximumFamItemId));l={};q={};t=[];for(n in this._famItems)if(this._famItems.hasOwnProperty(n)){d=this._famItems[n];p={};f=d.itemConfig.parents;if(null!=f){a=0;for(b=f.length;a<b;a+=1)k=f[a],this._famItems.hasOwnProperty(k)&&(k!=d.id&&!p.hasOwnProperty(k))&&(p[k]=!0,e=this._famItems[k],e.children.push(d.id),e.logicalChildren.push(d.id),d.logicalParents.push(k),d.parents.push(k),l.hasOwnProperty(k)||(l[k]={}),l[k][n]=k,q.hasOwnProperty(n)||(q[n]={}),q[n][k]=n)}e=d.itemConfig.spouses;
null!=e&&0<e.length&&t.push(d)}a=0;for(b=t.length;a<b;a+=1){v=t[a];p={};p[v.id]=!0;w=[v.id];e=v.itemConfig.spouses;c=0;for(d=e.length;c<d;c+=1)f=e[c],this._famItems.hasOwnProperty(f)&&!p.hasOwnProperty(f)&&(p[f]=!0,w.push(f));u=!1;e=0;for(f=v.logicalChildren.length;e<f;e+=1)if(c=this._famItems[v.logicalChildren[e]],c.logicalParents.length==w.length){x=!0;d=0;for(g=c.logicalParents.length;d<g;d+=1)if(!p.hasOwnProperty(c.logicalParents[d])){x=!1;break}if(x){u=!0;break}}if(!u){this.maximumFamItemId+=
1;p=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:!1,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0});this._famItems[p.id]=p;c=0;for(d=w.length;c<d;c+=1)f=w[c],e=this._famItems[f],e.logicalChildren.push(p.id),e.children.push(p.id),p.logicalParents.push(e.id),p.parents.push(e.id),l.hasOwnProperty(e.id)||(l[e.id]={}),l[e.id][p.id]=e.id,q.hasOwnProperty(p.id)||(q[p.id]={}),q[p.id][e.id]=p.id}}this._sortItemsBylevelsTopo(this._famItems);for(m in this._famItems)this._famItems.hasOwnProperty(m)&&
(d=this._famItems[m],d.logicalChildren.sort(function(a,b){return s._famItems[a].level-s._famItems[b].level}),d.logicalParents.sort(function(a,b){return s._famItems[b].level-s._famItems[a].level}));for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(this._famItems[m].level=null);this._sortItemsBylevelsSmart(this._famItems);if(0<this.options.annotations.length){for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(d=this._famItems[m],d.logicalChildren.length=0,d.logicalParents.length=0,
d.children.length=0,d.parents.length=0);c={};a=0;for(b=this.options.annotations.length;a<b;a+=1)r=this.options.annotations[a],3==r.annotationType&&(c.hasOwnProperty(r.fromItem)?c[r.fromItem].push(r):c[r.fromItem]=[r]);for(i in c)if(c.hasOwnProperty(i)){b=c[i];b.sort(function(a,b){return b.toItems.length-a.toItems.length});for(a=0;a<b.length;a+=1)r=b[a],this._addLabelAnnotation(l,r.fromItem,r.toItems,function(){var a=null;s.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:s.maximumFamItemId,
isVisible:!0,isActive:!1,itemConfig:r,levelGravity:1});s._famItems[a.id]=a;return a.id}),this._addLabelAnnotation(q,r.fromItem,r.toItems,function(){var a=null;s.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:s.maximumFamItemId,isVisible:!0,isActive:!1,itemConfig:r,levelGravity:2});s._famItems[a.id]=a;return a.id})}for(n in this._famItems)if(this._famItems.hasOwnProperty(n)){d=this._famItems[n];i=l[d.id];if(null!=i)for(j in i)i.hasOwnProperty(j)&&(e=d,i[j]!=d.id&&(e=this._famItems[i[j]]),
c=this._famItems[j],q.hasOwnProperty(j)&&q[j].hasOwnProperty(d.id)&&q[j][d.id]!=j&&(c=this._famItems[q[j][d.id]]),e.logicalChildren.push(c.id),c.logicalParents.push(e.id),e.children.push(c.id),c.parents.push(e.id));f=q[d.id];if(null!=f)for(k in f)f.hasOwnProperty(k)&&(e=this._famItems[k],c=d,f[k]==d.id&&!l.hasOwnProperty(k)&&(e.logicalChildren.push(c.id),c.logicalParents.push(e.id),e.children.push(c.id),c.parents.push(e.id)))}}a={};for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(a[m]=this._famItems[m].logicalChildren.slice(0));
a=primitives.common.optimizeReferences(a,function(){var a;s.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:s.maximumFamItemId,isVisible:!1,isActive:!1,levelGravity:2});s._famItems[a.id]=a;return a.id});for(m in a)a.hasOwnProperty(m)&&(i=a[m],s._famItems[m].logicalChildren=i);this._eliminateManyToMany(this._famItems,function(){s.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:s.maximumFamItemId,isVisible:!1,isActive:!1,itemConfig:new primitives.famdiagram.ItemConfig({id:s.maximumFamItemId}),
levelGravity:2})});this._resortItemsBylevels(this._famItems);this._fillInItems(this._famItems,function(){s.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:s.maximumFamItemId,levelGravity:2,isVisible:!1,isActive:!1})});this._setLogicalParents(this._famItems);if(this._debug)for(m in this._famItems)if(this._famItems.hasOwnProperty(m)){d=this._famItems[m];i=d.logicalChildren;for(a=0;a<i.length;a+=1){b=i[a];b=this._famItems[b];if(0>b.logicalParents.indexOf(m))throw"Family tree is broken. Logical child does not reference logical parent.";
if(null===b.level||null===d.level||b.level!=d.level+1)throw"Family tree is broken. Children/Parents or levels mismatch!";}}this._famItemsNonExtracted={};for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(this._famItemsNonExtracted[m]=this._famItems[m]);this.properties="title description image itemTitleColor groupTitle groupTitleColor isActive hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");this.defaultItemConfig=
new primitives.famdiagram.ItemConfig;a=null;for(b=0;null!=(a=this._findLargestRoot());)m=new primitives.famdiagram.Family(b),this._extractOrgChart(m,this._famItems[a]),this._families.push(m),b+=1;l=[];n={};if(0<this._families.length){a=0;for(b=this._families.length;a<b;a+=1){m=this._families[a];c=0;for(d=m.links.length;c<d;c+=1)i=m.links[c],j=this._famItems[i.fromItem].familyId,k=this._famItems[i.toItem].familyId,j!=k&&(h.hasOwnProperty(j)||(h[j]={}),h[j].hasOwnProperty(k)||(h[j][k]=0),h[j][k]+=1,
h.hasOwnProperty(k)||(h[k]={}),h[k].hasOwnProperty(j)||(h[k][j]=0),h[k][j]+=1),this._families[k].backLinks.push(new primitives.famdiagram.FamLink(i.toItem,i.fromItem))}for(;l.length<this._families.length;){a=0;for(b=this._families.length;a<b;a+=1)if(m=this._families[a],!n.hasOwnProperty(m.id))if(j=primitives.common.getGraphSpanningTree(h,m.id,function(a,b){return a-b}),j.hasOwnProperty(m.id)){this._countNumberOfSubFamilies(m.id,j);l.push(m.id);n[m.id]=!0;i=j[m.id];c=0;for(d=i.length;c<d;c+=1){m=this._getFamilyAndItsSubFamilies(i[c],
j);e=0;for(f=m.length;e<f;e+=1)k=m[e],l.push(k),n[k]=!0}}else l.push(m.id),n[m.id]=!0}}this.maximumFamItemId+=1;this._orgItemRoot=this._createOrgItem(this.maximumFamItemId,null,null,this.minimumLevel-1,null);this._orgItemRoot.hideParentConnection=!0;this._orgItemRoot.hideChildrenConnection=!0;this._orgItemRoot.title="internal root";this._orgItemRoot.isVisible=!1;this._orgItemRoot.isActive=!1;n={};a=0;for(b=l.length;a<b;a+=1){m=this._families[l[a]];j={};k=this._orgItemRoot;d=0;h=m.links.concat(m.backLinks);
for(c=0;c<h.length;c+=1)if(i=h[c],q=this._orgItems[i.toItem],i=this._orgItems[i.fromItem],!0==n[q.familyId]){for(i=m.items[0];q.level>=i.level;)q=this._orgItems[q.parent];j[q.id]=j.hasOwnProperty(q.id)?j[q.id]+1:1;d<j[q.id]&&(k=q,d=j[q.id])}this._attachFamilyToOrgChart(k,m);n[m.id]=!0}a=this._getExtraGravity();b=this._getGrandChildren();this._balanceChildrenForItem(a,b,this._orgItemRoot)}};
...
primitives.famdiagram.Controller.prototype._balanceChildrenForItem=function(a,b,c){var d,e,f,g,h,i,j,k,l,n,m,q=[c],p,s=[],r,t,v,w,u;for(c.childIndex=0;0<q.length;){c=0;for(j=q.length;c<j;c+=1)if(p=q[c],d={},e={},this._orgItemChildren.hasOwnProperty(p.id)){t=this._orgItemChildren[p.id];l=null;r=[];if(0<t.length){f=0;for(g=t.length;f<g;f+=1){k=t[f];null==l&&(l=k);e[k.id]={};if(a.hasOwnProperty(k.id))for(w in m=a[k.id],m)if(m.hasOwnProperty(w)){u=m[w];e[k.id][w]={};h=0;for(i=u.length;h<i;h+=1)n=u[h],
n=n.commonParent==p.id?n.toParent:this._orgItems[n.fromParent].childIndex<this._orgItems[n.toParent].childIndex?"__right__":"__left__",k.id!=n&&(d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(n)||(d[k.id][n]=0),d[k.id][n]+=1,null==e[k.id][w][n]&&(e[k.id][w][n]=0),e[k.id][w][n]+=1)}0<f&&(d.hasOwnProperty(l.id)||(d[l.id]={}),d[l.id].hasOwnProperty(k.id)||(d[l.id][k.id]=0),d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(l.id)||(d[k.id][l.id]=0))}if(null!=l){f=0;l=l.id;for(v in d)if(d.hasOwnProperty(v)){g=
d[v];h=0;for(n in g)g.hasOwnProperty(n)&&(h+=g[n]);h>f&&(l=v,f=h)}d=primitives.common.getGraphGrowthSequence(d,l,function(a){return a});l=this._balanceItems(d,"__left__","__right__",e,b);e=0;for(d=l.length;e<d;e+=1)f=this._orgItems[l[e]],f.childIndex=e,r.push(f)}if(this._debug&&!primitives.common.compareArrays(this._orgItemChildren[p.id],r,function(a){return a.id}))throw"Balancing of items is broken! Incoming vs. outgoing arrays of items mismatch.";this._orgItemChildren[p.id]=r}s=s.concat(t)}q=s;
s=[]}};
primitives.famdiagram.Controller.prototype._balanceItems=function(a,b,c,d,e){var f=[],g,h,i,j,k,l,n,m,q,p,s,r,t,v,w,u,x,z,A,y;h=new primitives.famdiagram.Slots;h.add(new primitives.famdiagram.Slot(b));h.add(new primitives.famdiagram.Slot(null));h.add(new primitives.famdiagram.Slot(c));i=0;h.loop(function(a){i+=1;a.position=i});for(g=0;g<a.length;g+=1)if(j=a[g],j!=b&&j!=c)for(x in q=m=n=l=k=null,h.loop(function(a){var b,c,f,g;if(null==a.itemId){v=e[j];t=r=s=p=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(v&&
null!=v[b]&&(p+=a.crossings[b]*v[b]),t+=a.crossings[b]);for(b in d[j])if(d[j].hasOwnProperty(b))for(c in f=d[j][b],f)f.hasOwnProperty(c)&&(g=h.getSlot(c),null!=g&&(g.position<a.position?(p+=(a.left[b]||0)-(g.left[b]||0),r+=Math.abs(g.balance+1)):(p+=(a.right[b]||0)-(g.right[b]||0),r+=Math.abs(g.balance-1)),s+=Math.abs(g.position-a.position)));if(null==l||l>p||l==p&&(n>s||n==s&&(m>r||m==r&&q>t)))l=p,k=a,n=s,m=r,q=t}}),w=k.clone(),u=k.clone(),u.itemId=j,h.insertBefore(k,w),h.insertBefore(k,u),i=u.position=
...
primitives.orgdiagram.Buffer=function(a){this.polylines=[];this.palette=[];this.cursor=0;0==a.linesPalette.length?(this.palette=[new primitives.famdiagram.PaletteItemConfig(a.linesColor,a.linesWidth,a.linesType)],this.paletteLength=this.palette.length,this.regularIndex=0):(this.palette=a.linesPalette.slice(0),this.paletteLength=this.palette.length,this.palette.push(new primitives.famdiagram.PaletteItemConfig(a.linesColor,a.linesWidth,a.linesType)),this.regularIndex=this.palette.length-1);this.palette.push(new primitives.famdiagram.PaletteItemConfig(a.highlightLinesColor,
a.highlightLinesWidth,a.highlightLinesType));this.highlightIndex=this.palette.length-1};primitives.orgdiagram.Buffer.prototype.selectPalette=function(a){this.cursor=a%this.paletteLength};primitives.orgdiagram.Buffer.prototype._getPolyline=function(a,b){a[b]||(a[b]=new primitives.orgdiagram.Polyline(this.palette[b]));return a[b]};
primitives.orgdiagram.Buffer.prototype.getPolyline=function(a){var b=null;switch(a){case 1:b=this.regularIndex;break;case 2:b=this.highlightIndex;break;case 0:b=this.cursor}return this._getPolyline(this.polylines,b)};primitives.orgdiagram.Buffer.prototype.getPolylines=function(){var a,b,c,d=[];a=0;for(b=this.polylines.length;a<b;a+=1)if(c=this.polylines[a])c.optimizeMoveSegments(),d.push(c);return d};
primitives.orgdiagram.Buffer.prototype.addInverted=function(a){var b,c,d,e;c=this.polylines;this.polylines=[];null!=a&&a(this);a=0;for(b=this.polylines.length;a<b;a+=1)d=this._getPolyline(this.polylines,a),e=this._getPolyline(c,a),e.addInverted(d);this.polylines=c};
...
primitives.orgdiagram.Polyline.prototype.addInverted=function(a){var b=a.segments,c,d;if(0<b.length){d=b[b.length-1].getEndPoint();this.segments.push(new primitives.common.MoveSegment(d));for(a=b.length-1;0<a;a-=1)c=b[a],d=b[a-1],4!=c.segmentType&&4!=d.segmentType&&(d=d.getEndPoint(),c.invert(d)),this.segments.push(c)}};
primitives.orgdiagram.Polyline.prototype.optimizeMoveSegments=function(){var a,b,c,d,e;c={};var f=[],g=[];a=0;for(b=this.segments.length;a<b-1;a+=1)switch(d=this.segments[a],e=this.segments[a+1],d.segmentType){case 0:case 2:case 3:switch(e.segmentType){case 1:case 4:d=d.x+"&"+d.y,c.hasOwnProperty(d)||(c[d]=a)}break;case 1:d=d.x+"&"+d.y,c.hasOwnProperty(d)&&!f[c[d]]&&(f[c[d]]=a+1,g[a]=!0)}e=[];for(a=0;a<b;a+=1)if(!g[a]&&(d=this.segments[a],e.push(d),g[a]=!0,0<f[a]))for(c=f[a];c<b&&!g[c];)d=this.segments[c],
e.push(d),g[c]=!0,c=0<f[c]?f[c]:c+1;this.segments=e};primitives.orgdiagram.Polyline.prototype.toString=function(){return this.lineColor+"."+this.lineWidth+"."+this.lineType};
