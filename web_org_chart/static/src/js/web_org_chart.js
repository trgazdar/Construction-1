            ...
            function getZoom2Template() {
                ...
                var itemTemplate = jQuery(
                        ...
                        + '<div style="position: relative;">'
                        	...
                        	+ '<div style="margin-left: 30%;position: absolute;top:2px;width: 70%;">'
	                        	+ '<div name="description" class="bp-item" style="font-size: 9px;word-break: break-all;"></div>' 
                ...
                var itemTemplate = jQuery(
                		'<div class="bp-item bp-corner-all bt-item-frame" style="border-width: 1px; width: 95px; height: 99px;  left: 922.5px; position: absolute; padding: 0px; margin: 0px; visibility: inherit;">'
	                        ...
	                        + '<div style="position: relative;">'
	                        	...
	                        	+ '<div style="margin-left: 30%;position: absolute;top:2px;width: 70%;">'
		                        	+ '<div name="description" class="bp-item" style="font-size: 12px;word-break: break-all;"></div>' 
