...
class HrCustody(models.Model):
    ...
    renew_rejected_reason = fields.Text(string='Renew Rejected Reason',tracking=True, readonly=True,
    ...
    purpose = fields.Char(string='Reason', tracking=True, required=True, readonly=True,
                          states={'draft': [('readonly', False)]})
    ...
    return_date = fields.Date(string='Return Date', required=True, tracking=True, readonly=True,
                              states={'draft': [('readonly', False)]})
    renew_date = fields.Date(string='Renewal Return Date', tracking=True, readonly=True, copy=False)
